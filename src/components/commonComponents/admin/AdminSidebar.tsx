...
const sidebarContent = [
    {icon: <MdOutlineDashboard/>, label: 'Dashboard', path: '/admin/dashboard'},
...
const AdminSidebar: React.FC = () => {
  ...
  return (
    <nav className="bg-white max-h-96 overflow-hidden transition-all w-64 rounded-lg shadow-lg mt-4">
